  ...
  items: [
    ...
    },
    {
      ...
      subItems: [
        ...
        { id: 'sub-f3', title: 'Monthly Calendar (থাগী ক্যালেন্ডার)', href: '/calendar', description: 'Manipuri Lunar Month, Saka Date, & Thabanik', badge: 'NEW', active: true },
        { id: 'sub-f4', title: 'Free 6-Card Tarot Reading', href: '/tarot', description: 'Interactive 6-card divine tarot forecast', badge: 'NEW', active: true },
        { id: 'sub-f5', title: 'Free Vastu Shastra Audit', href: '/vastu', description: 'Floorplan harmony & non-demolition remedies', badge: 'POPULAR', active: true },
      ],
    },
    {
      id: 'nav-6',
        ...
        <div className="max-w-7xl mx-auto py-2 px-4 sm:px-6 lg:px-8 flex flex-wrap justify-between items-center gap-2">
          <div className="flex flex-wrap items-center gap-4 sm:gap-6">
            <div className="flex items-center gap-1.5 font-medium">
              ...
              <span>{headerSettings.supportTiming}</span>
            </div>
            <div className="hidden sm:flex items-center gap-1.5 font-medium">
              <Mail className="w-3.5 h-3.5 text-[#b45309]" />
              <a href={`mailto:${headerSettings.supportEmail}`} className="hover:underline">
                {headerSettings.supportEmail}
              </a>
            </div>
            <div className="flex items-center gap-1.5 font-bold">
              <Phone className="w-3.5 h-3.5 text-[#b45309]" />
              <a href={`tel:${headerSettings.supportPhone}`} className="hover:underline">
                {headerSettings.supportPhone}
              </a>
            </div>
          </div>
            ...
            {user ? (
              <div className="relative">
                ...
                >
                  ...
                  <span>{user.name ? user.name.toUpperCase() : 'MY ACCOUNT'}</span>
                ...
                <AnimatePresence>
                  {showUserDropdown && (
                    ...
                    >
                      ...
                      <Link
                        href={user.role === 'ASTROLOGER' ? '/dashboard/astrologer' : '/profile'}
