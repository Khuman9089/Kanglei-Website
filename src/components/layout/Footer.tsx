    ...
    <footer className="bg-[#0f172a] text-gray-300 border-t border-[#1e293b] font-sans">
      <div className="max-w-7xl mx-auto px-4 py-16 md:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          <div className="space-y-4">
            <div className="flex items-center space-x-2.5">
              ...
              <span className="font-serif text-2xl font-bold text-white">KangleiAstro</span>
            </div>
            <p className="text-xs text-gray-400 leading-relaxed">
              Guiding your path with authentic Vedic wisdom, precise Swiss Ephemeris calculations, and practical Jyotish remedies.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-xs text-gray-300">
              ...
              <li><Link href="/kundli" className="hover:text-[#fbbf24] transition-colors">Free Kundli Generator</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-xs text-gray-300">
              ...
              <li><Link href="/services" className="hover:text-[#fbbf24] transition-colors">Yearly Transit Forecast</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-xs text-gray-300">
              <li className="font-medium text-white">ccare@kangleiastro.com</li>
        ...
        <div className="mt-12 pt-8 border-t border-[#1e293b] flex flex-col sm:flex-row justify-between items-center text-xs text-gray-400 gap-4">
          <p>&copy; {new Date().getFullYear()} KangleiAstro. All rights reserved.</p>
