...
export const YUMSHAROL_DIRECTIONS: Record<number, YumsharolDirection> = {
  ...
  2: {
    ...
    directionManipuri: 'Nongpok-Thambal / Meiram (অগ্নি কোণ)',
    symbol: '💨',
  ...
  3: {
    ...
    direction: 'South',
    directionManipuri: 'Makha (মখা / যম কোণ)',
    symbol: '🦁',
    quality: 'Auspicious',
  ...
  4: {
    ...
    directionManipuri: 'Makha-Nongchup (নৈঋত কোণ)',
    symbol: '🐕',
    quality: 'Inauspicious',
  ...
  6: {
    ...
    directionManipuri: 'Nongchup-Awang (বায়ু কোণ)',
    symbol: '🐴',
    quality: 'Inauspicious',
  ...
  8: {
    ...
    directionManipuri: 'Awang-Nongpok (ঈশান কোণ)',
    symbol: '🦅',
    quality: 'Inauspicious',
