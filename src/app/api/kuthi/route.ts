    ...
    if (!error && data && data.length > 0) {
      const dbOrders: KuthiOrder[] = data.map((d: any) => {
        ...
        return {
          ...
          email: d.email || '',
          kuthiAttached: !!d.kuthi_attached || !!localMatch?.kuthiAttached || !!d.kuthi_file_name || !!localMatch?.kuthiFileName,
          kuthiFileName: d.kuthi_file_name || localMatch?.kuthiFileName || 'client_kuthi_document.pdf',
          kuthiFileUrl: d.kuthi_file_url || localMatch?.kuthiFileUrl || '/sample_kuthi.pdf',
          uploadedFiles: d.uploaded_files || localMatch?.uploadedFiles || (d.kuthi_file_name ? [d.kuthi_file_name] : (localMatch?.kuthiFileName ? [localMatch.kuthiFileName] : ['client_kuthi_document.pdf'])),
          dob: d.dob,
          tob: d.tob,
          pob: d.pob,
          utr: d.utr,
