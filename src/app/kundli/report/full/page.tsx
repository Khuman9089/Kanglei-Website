    ...
    <div className="min-h-screen bg-[#f1f5f9] text-slate-900 font-sans pb-16">
      ...
      <div className="sticky top-0 z-40 bg-white/95 backdrop-blur-md border-b border-amber-200/80 shadow-xs px-4 py-3 print:hidden">
        <div className="max-w-4xl mx-auto flex items-center justify-between gap-3">
          ...
          >
            ...
            <span>{isDownloading ? 'Downloading PDF...' : 'Save as PDF'}</span>
          </button>
        </div>
      </div>
      ...
      <div className="max-w-4xl mx-auto px-4 pt-6 space-y-6" id="full-kundli-report-content">
        ...
        {/* ─────────────────────────────────────────────────────────────
           ...
           ───────────────────────────────────────────────────────────── */}
        <div className="pdf-card bg-white rounded-2xl border border-slate-200/90 shadow-md p-8 sm:p-12 text-center space-y-8 min-h-[950px] flex flex-col justify-between">
        ...
        <div className="pdf-card bg-white rounded-2xl border border-slate-200/90 shadow-md p-6 sm:p-8 space-y-5">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="p-4 rounded-2xl bg-[#fffdf7] border border-amber-200 space-y-2 text-xs">
              ...
              <div className="space-y-1.5">
                <div className="flex justify-between border-b border-slate-100 pb-1"><span className="text-slate-500">Tithi:</span><span className="font-bold">KrishnaSaptami</span></div>
                <div className="flex justify-between border-b border-slate-100 pb-1"><span className="text-slate-500">Karana:</span><span className="font-bold">Vishti</span></div>
                <div className="flex justify-between border-b border-slate-100 pb-1"><span className="text-slate-500">Nakshatra:</span><span className="font-bold">Ashwini</span></div>
                <div className="flex justify-between border-b border-slate-100 pb-1"><span className="text-slate-500">Nakshatra Lord:</span><span className="font-bold">Ketu</span></div>
                <div className="flex justify-between border-b border-slate-100 pb-1"><span className="text-slate-500">Yoga:</span><span className="font-bold">Shoola</span></div>
                <div className="flex justify-between border-b border-slate-100 pb-1"><span className="text-slate-500">Ascendant:</span><span className="font-bold">Taurus</span></div>
          ...
          <div className="p-4 rounded-2xl bg-amber-50/50 border border-amber-200/80 space-y-2 text-xs">
            ...
            <div className="grid grid-cols-3 md:grid-cols-4 gap-2">
              <div><span className="text-slate-400 block text-[10px]">VARNA</span><span className="font-bold text-slate-900">Kshattriya</span></div>
              <div><span className="text-slate-400 block text-[10px]">VASHYA</span><span className="font-bold text-slate-900">Chatushpada</span></div>
              <div><span className="text-slate-400 block text-[10px]">YONI</span><span className="font-bold text-slate-900">Ashva</span></div>
              <div><span className="text-slate-400 block text-[10px]">GANA</span><span className="font-bold text-slate-900">Dev</span></div>
              <div><span className="text-slate-400 block text-[10px]">NADI</span><span className="font-bold text-slate-900">Adhya</span></div>
              <div><span className="text-slate-400 block text-[10px]">SIGN</span><span className="font-bold text-slate-900">Aries</span></div>
              <div><span className="text-slate-400 block text-[10px]">SIGN LORD</span><span className="font-bold text-slate-900">Mars</span></div>
              <div><span className="text-slate-400 block text-[10px]">CHARAN</span><span className="font-bold text-slate-900">1</span></div>
              <div><span className="text-slate-400 block text-[10px]">TATVA</span><span className="font-bold text-slate-900">Fire</span></div>
              <div><span className="text-slate-400 block text-[10px]">PAYA</span><span className="font-bold text-slate-900">Gold</span></div>
              <div><span className="text-slate-400 block text-[10px]">YUNJA</span><span className="font-bold text-slate-900">Poorva</span></div>
              <div><span className="text-slate-400 block text-[10px]">NAME ALPHABET</span><span className="font-bold text-slate-900">Chu</span></div>
            </div>
          </div>
        </div>
